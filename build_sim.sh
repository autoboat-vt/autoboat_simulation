docker buildx build --build-arg max_step_size=0.001 --build-arg physics_type=ode --tag vtautoboat/autoboat_simulation --cache-from type=registry,ref=lucasmrdt/sailboat-sim-lsa-gym .
